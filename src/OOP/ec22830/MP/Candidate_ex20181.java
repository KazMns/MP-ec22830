package OOP.ec22830.MP;// File Candidate_ex20181.java

import java.util.Scanner;
import java.util.Random;

class Candidate_ex20181 extends Candidate
{
	...
	if (candidates1[0] == null)
	{
		for (int i = 0; i < candidates1.length; i ++)
		{
			candidates1[i] = new Candidate_ex20181();
		}
	}
    ...
    public static void mostCommonWinner(final int noOfTimes, Candidate[] candidates, Candidate voteCounter)
    {
    	...
    	for (int i = 0; i < noOfTimes; i++)
    	{
            ...
            { 
                Candidate candidate = new Candidate_ex20181();
    ...
    public Candidate vote(Candidate[] candidates)
    {
        ...
        if (length == 0)
        {
            return new Candidate_ex20181();
        }
        else
        {
            for (int i = 0; i < length; i++)
            {
                if (((candidates[i]).getSlogan()).equals("No more exams"))
                {
                    candidateIndex = i;
                }
            }
