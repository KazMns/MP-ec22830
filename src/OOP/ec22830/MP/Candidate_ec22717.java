...
class Candidate_ec22717 extends Candidate
{
    ...
    public Candidate vote(Candidate[] candidates) {
        Candidate r = new Candidate_ec22717();
...
public static void main(String[] args)
{
    ...
    while(!valid)
    {
        ...
        char menu = inputChar("Would you like to a) Add a specific candidate b) Add a random candidate c) Run the election?");
