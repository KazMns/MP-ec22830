...
import java.util.Scanner;
 ...
 class Candidate_ec221207 extends Candidate {
...
//including array found within github to allow the election to run
     ...
     public static void printMenu(Candidate[] aCandidates, Candidate[] candidatesElection) {
         ...
         do {
             ...
             if (Choice.equals("a")) {
                 Candidate[] newCandidatesElection = SpecificCandidate(aCandidates, candidatesElection);
     ...
     public static Candidate[] SpecificCandidate(Candidate[] aCandidates, Candidate[] candidatesElection) {
         ...
         Candidate[] newCandidatesElection = CandidateToArray(candidatesElection, specificCandidate);
     ...
     public static Candidate[] RandomCandidate(Candidate[] aCandidates, Candidate[] candidatesElection) {
         ...
         Candidate[] newCandidatesElection = CandidateToArray(candidatesElection, aCandidates[c]);
         return newCandidatesElection;
     }

     public static Candidate[] CandidateToArray(Candidate[] candidatesElection, Candidate candidateToAdd) {
