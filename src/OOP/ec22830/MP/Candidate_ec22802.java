package OOP.ec22830.MP;// File Candidate_ec22802.java
//
...
class Candidate_ec22802 extends Candidate {
    ...
    public Candidate vote(Candidate[] candidates) {
        Candidate r = new Candidate_ec22802();
        ...
        if (candidates.length == 0)
          ...
          for (Candidate c : candidates){
            if (c.getName().equals("Rope"))
                return c;
                }
                
          for (Candidate c : candidates){
            if (c.getSlogan().equals("Smth new"))
                return c;
                }
