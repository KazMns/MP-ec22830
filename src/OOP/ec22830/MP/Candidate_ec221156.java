...
class Candidate_ec221156 extends Candidate {
    public String getName() {
        return "David";
            }
    public String getSlogan() {
        return "ChatGPT is aight!";
    }
    ...
    public Candidate vote(Candidate[] candidates) {
        Candidate r = new Candidate_ec221156();
          ...
          for (Candidate c : candidates){
            if (c.getSlogan().equals("ChatGPT is aight!"))
                return c;
                }
