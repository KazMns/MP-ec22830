...
import java.util.Scanner;
 ...
 // File Candidate_ec22777.java



 class Candidate_ec22777 extends Candidate {
     ...
     public String getSlogan() {
         return "More Buildings";
      
     }
     

     public Candidate vote(Candidate[] candidates) {
         Candidate r = new Candidate_ec22777();
         ...
         for (Candidate c: candidates){
             if (c.getName().equals("Bob") && c.getSlogan().equals("More Buildings")) {
             return c;}
             }
