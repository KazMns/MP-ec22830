package OOP.ec22830.MP;// File Candidate_ec22862.java
//
...
class Candidate_ec22862 extends Candidate {
    ...
    public Candidate vote(Candidate[] candidates) {
        Candidate r = new Candidate_ec22862();
        ...
        if (candidates.length == 0)
          ...
          for (Candidate c : candidates){
            if (c.getName().equals("Borat"))
                return c;
                }

          for (Candidate c : candidates){
            if (c.getSlogan().equals("I like!"))
                return c;
                }
