package OOP.ec22830.MP;// File Candidate_ec22586.java
//
...
class Candidate_ec22586 extends Candidate {
    ...
    public Candidate vote(Candidate[] candidates) {
        Candidate r = new Candidate_ec22586();
