package OOP.ec22830.MP;// File Candidate_ec22561.java
//
...
class Candidate_ec22561 extends Candidate {
    ...
    static <T> T input(String message){
        Scanner scan = new Scanner(System.in);
        System.out.println(message);
        T answer = (T) scan.nextLine();
        return answer;
    }
    ...
    static void OptionC(Candidate [] all,ArrayList<Candidate> candidates){
        ...
        Candidate [] contenders = ListtoArray(candidates);
        int num = input("Hoe many times would you like to run the election?");
