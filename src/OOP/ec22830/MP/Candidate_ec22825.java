package OOP.ec22830.MP;// File Candidate_ec22825.java
//
...
class Candidate_ec22825 extends Candidate {
            ...
            else if (choice == 'c')
            {
                System.out.println("Please enter a username");
                 name = sc.nextLine();
                     ...
                     elections(candidates, count, numTimes, c);
                     // Once completed, exit
    ...
    public static void elections(Candidate[] candidates, int count, int numTimes, Candidate c) {
         Candidate[] cand = new Candidate[count];
         for (int i = 0; i < count; i++) {
