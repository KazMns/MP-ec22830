package OOP.ec22830.MP;// File Candidate_ec22426.java
//
//  Assignment 3
...
class Candidate_ec22426 extends Candidate {
    ...
    public Candidate vote(Candidate[] candidates) {
        Candidate r = new Candidate_ec22426();
        ...
        for (int i = 0; i <= repeat; i++) {
            for (int j = 0; j < candidateCount; j++) {
                try {
                    ...
                    winningCandidates[j] = new Candidate_ec22426();
                }
            }
        }
