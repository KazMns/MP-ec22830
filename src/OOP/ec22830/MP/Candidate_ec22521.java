package OOP.ec22830.MP;// If your code uses libraries, be sure to include the necessary
// import lines in your file Candidate_/un/.java
import java.util.Random;

class Candidate_ec22521 extends Candidate {
